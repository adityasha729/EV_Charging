...
def send_message():
    ...
    help_agent_prompt = (
        ...
        "Never recommend a kiosk that is occupied or unavailable. If all kiosks are risky, suggest the least risky available one or you may suggest to skip (please suggest to skip rarely). "
        "Be brief, clear, Only mention the kiosk(s) and a short reason why they should or should not be chosen. "
